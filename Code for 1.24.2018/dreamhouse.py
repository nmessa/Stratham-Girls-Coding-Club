...
def drawHouseBody():
    #Get two points to define house body (p1 and p2)
    #Add code here

    #Pick a color at random
    #Add code here

    #Create a rectangle called house
    #Add code here
...
def drawRoof():
    ...
    #return p3, p4, p5, and roofColor
    return p3, p4, p5, roofColor

def drawChimney(roofColor):
    #get coordinates for chimney rectangle
    p6 = win.getMouse()
    ...
    #Recreate roof object
    #Add code here

    #Redraw the roof by setting roofColor and drawing roof
    #Add code here

def drawDoor():
    #Get and derive coordinates for the door
    p = win.getMouse()
...
def drawRoundWindow():
    #Get position of round window
    #Add code here

    #Get color for round window
    #Add code here

    #Construct the circle
    #Add code here

    #Set color for round window
    #Add code here
